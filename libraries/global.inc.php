...
function getDamageTypeList($key = FALSE)
{
  $list = array(
    1 => 'Acid',
    2 => 'Bl', // Bludgeoning
...
function getRarityList($key = FALSE)
{
  $list = array(
    1 => 'Common',
    2 => 'Uncommon',
...
function getRangeList($key = FALSE)
{
  $list = array(
    1 => 'Self',
    2 => 'Unlimited',
...
function getSchoolList($key = FALSE)
{
  $list = array(
    1 => 'Abjuration',
    2 => 'Conjuration',
...
function getSpeedList($key = FALSE)
{
  $list = array(
    1 => 'Instant',
    2 => 'Re', // Reaction
...
function getDurationList($key = FALSE)
{
  $list = array(
    1 => 'Forever',
    3 => 'End of targets next turn',
    6 => 'End of your next turn',
    60 => '1 Minute',
    600 => '10 Minutes',
    3600 => '1 Hour',
    7200 => '2 Hours',
